...
echo "<table>";
    echo '<tr><th>Doctor Name</th><th>Username</th><th>Appointment Date</th><th>Appointment Time</th></tr>';
while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){  
echo "<tr><td>" . $row['d_name'] . "</td><td>" . $row['username'] . "</td><td>" . $row['a_date'] . "</td><td>" . $row['a_time'] . "</td></tr>";  
}
