...
if(empty($firstnameErr)&&empty($lastnameErr)&&empty($usernameErr)&&empty($passwordErr)&&empty($genderErr)&&empty($emailErr))
{
    ...
    if (mysqli_query($establish_connection,"INSERT INTO userdata (username,firstname,lastname,password,email,dob) VALUES ('$username','$firstname','$lastname','$password','$mail','$dob')")) {
...
-->
                        ...
                        <div class="col-md-3 news1">
                            <div class="row">
                                <img src="images/patientregistration.jpg" style="width: 300px;height: 300px; margin-top:30%; margin-left:10%">
                                <!-- ./container -->
                            </div>
    ...
    ?>
                <style>
                    <?php include 'cssfiles/footer.css?version=51 ';
                    ?>
